...
func isPastLeftBound(position: Vector2) -> bool:
  return position.x <= _leftBound

func isPastRightBound(position: Vector2) -> bool:
  return position.x >= _rightBound

func isPastTopBound(position: Vector2) -> bool:
  return position.y <= _topBound
  
func isPastBottomBound(position: Vector2) -> bool:
